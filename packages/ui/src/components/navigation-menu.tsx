...
const NavigationMenuViewport = ({
  ...
  navigationMenuTriggerStyle = cva(
    'bg-background data-[state=open]:bg-accent/50 data-[state=open]:focus:bg-accent data-[state=open]:hover:bg-accent data-[state=open]:text-accent-foreground disabled:opacity-50 disabled:pointer-events-none focus-visible:outline-1 focus-visible:ring-[3px] focus-visible:ring-ring/50 focus:bg-accent focus:text-accent-foreground font-medium group h-9 hover:bg-accent hover:text-accent-foreground inline-flex items-center justify-center outline-none px-4 py-2 rounded-md text-sm transition-[color,box-shadow] w-max'
  ),
  ...
  NavigationMenuLink = ({ className, ...props }: React.ComponentProps<typeof NavigationMenuPrimitive.Link>) => (
    <NavigationMenuPrimitive.Link
      className={cn(
        "[&_svg:not([class*='size-'])]:size-4 [&_svg:not([class*='text-'])]:text-muted-foreground data-[active=true]:bg-accent/50 data-[active=true]:focus:bg-accent data-[active=true]:hover:bg-accent data-[active=true]:text-accent-foreground flex flex-col focus-visible:outline-1 focus-visible:ring-[3px] focus-visible:ring-ring/50 focus:bg-accent focus:text-accent-foreground gap-1 hover:bg-accent hover:text-accent-foreground outline-none p-2 rounded-sm text-sm transition-all",
        className
      )}
