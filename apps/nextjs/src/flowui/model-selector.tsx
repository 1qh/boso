...
const Groq = (props: SVGProps<SVGSVGElement>) => (
    <svg height='1em' viewBox='0 0 201 201' width='1em' xmlns='http://www.w3.org/2000/svg' {...props}>
      <title>Groq</title>
      <path d='M0 0h201v201H0V0Z' fill='#F54F35' />
      <path
...
export const MODELS = [
  ...
  ModelIcons: Record<Model, ElementType> = {
...
export const ModelSelector = ({ disabledModels, onChange, value, ...props }: ModelSelectorProps) => (
  <Select onValueChange={onChange} value={value} {...props}>
    ...
    <SelectContent>
      {MODELS.map(model => {
        ...
        return (
          <SelectItem disabled={disabledModels?.includes(model)} key={model} value={model}>
